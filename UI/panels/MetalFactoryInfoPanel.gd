...
export var upgrade_shop_path = "res://UI/shop/sorting shop/MetalUpgradeShop.tscn"
...
func _update_resource_panel():
	$VBoxContainer/ResourcePanel/HBoxContainer/Label.text = str(GameData.resources["metal"])
	$VBoxContainer/WastePanel/HBoxContainer/Label.text = "%s / minute" % str(GameData.factory_output["metal_waste"])
