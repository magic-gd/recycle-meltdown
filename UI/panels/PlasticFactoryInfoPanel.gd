...
export var upgrade_shop_path = "res://UI/shop/sorting shop/PlasticUpgradeShop.tscn"
...
func _update_resource_panel():
	$VBoxContainer/ResourcePanel/HBoxContainer/Label.text = str(GameData.resources["plastic"])
	$VBoxContainer/WastePanel/HBoxContainer/Label.text = "%s / minute" % str(GameData.factory_output["plastic_waste"])
